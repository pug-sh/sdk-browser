 ...
 */
export declare const isAutomatedBrowser: () => boolean;
export declare const setAutomationSuppressed: (suppressed: boolean) => void;
export declare const isAutomationSuppressed: () => boolean;
