...
export const makeStorageKey = (projectId, name) => `__pug_${projectId}_${name}__`;
 ...
 * its own spies.
 */
export const encodeStored = (value, expiresAt) => 
...
const DEFAULT_REDACTED_SET = new Set(DEFAULT_REDACTED_URL_PARAMS);
// null disables redaction entirely.
let redactedParams = DEFAULT_REDACTED_SET;
/**
 ...
 */
export const configureUrlRedaction = (params) => {
...
const isRedactedKey = (lowerKey) => redactedParams !== null &&
 ...
 */
export const isCaptureSuppressed = (el) => !!el?.closest('[data-pug-no-capture]');
/**
 ...
 */
export const getSafeElementText = (el, maxLength) => {
 ...
 * @see docs/design-notes/utils.md#storage-probe
 */
const sweepStaleProbeKeys = (currentKey) => {
...
const hasHeadlessBrand = (brands) => brands?.some(b => typeof b.brand === 'string' && b.brand.includes(HEADLESS_BRAND)) === true;
/**
...
export const setAutomationSuppressed = (suppressed) => {
    automationSuppressed = suppressed;
};
export const isAutomationSuppressed = () => automationSuppressed;
