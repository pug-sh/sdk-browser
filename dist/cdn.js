...
import { autoInitFromScript, installPug, replayQueue } from './cdn-install.js';
import { destroy, getTrackingConsent, identify, init, isConsentPending, isTrackingEnabled, optInTracking, optOutTracking, reset, rotate, setAutoCapture, setTrackingConsent, track, } from './index.js';
...
if (typeof window !== 'undefined') {
    const installed = installPug(window, api);
    if (installed) {
