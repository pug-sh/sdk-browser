...
import { configureUrlRedaction, DEFAULT_ENDPOINT, DEVICE_ID_KEY, RESERVED_DISTINCT_ID_PREFIX, safeStringify, } from './utils.js';
let state = null;
...
export const getTrackingConsent = () => {
    if (!state) {
        log.warn('getTrackingConsent() called before init(); returning undefined — a persisted choice is only read during init().');
        return undefined;
    }
