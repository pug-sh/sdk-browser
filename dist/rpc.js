...
const codeFromHttpStatus = (status) => {
    switch (status) {
        case 401:
...
const errorFromResponse = async (res, methodName) => {
    try {
 ...
 */
export const unaryCall = async (endpoint, apiKey, method, message, timeoutMs = DEFAULT_TIMEOUT_MS) => {
