...
export type WellKnownEventPropsMap = {
    [K in WellKnownEventName]: MessageInitShape<WellKnownSchemaMap[K]>;
};
/**
 ...
 */
export type TrackEventProps<E extends string> = [E] extends [WellKnownEventName] ? WellKnownEventPropsMap[E & WellKnownEventName] & Record<string, PropValue> : Record<string, PropValue>;
/**
 ...
 */
export type TrackFn = <E extends WellKnownEventName | (string & {})>(event: E, props?: TrackEventProps<E>, options?: TrackOptions) => void;
